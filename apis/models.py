...
class Manager(models.Model):
    ...
    owner = models.ForeignKey('auth.User', related_name='owner_manager', on_delete=models.CASCADE, null=True, blank=True)
...
# They will be different from each other by their item_code(i.e Barcode)
