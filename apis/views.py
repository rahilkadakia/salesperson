...
def ChangePassword(request):
    ...
    try:
        ...
        user.save()
        d = {"message": 1}  # Password Reset Successful
        return JsonResponse(d, status=status.HTTP_200_OK)
    except:
        d = {"message": 0}  # Password Reset Unsuccessful,Display Invalid Username
...
class TotalTargetsViewSet(viewsets.ModelViewSet):
    queryset = TotalTargets.objects.all()
    serializer_class = TotalTargetsSerializer
    permission_classes = (permissions.IsAdminUser, )
